...
mod tests {
    ...
    use common::{lang_value::LangValue, types::ReturnKind, ast::{ASTChild, ASTNode}, external_functions::IntoExtFunc};
    use tokenizer::tokenizer;
    use parser::parser;
    use vm::{vm::{evaluate, EvalResult}, scope::Scope};
    ...
    fn basic() {
        ...
        return sum(20, 10)
        "#;
        let tokens = tokenizer::tokenize(script.to_string()).unwrap();
